...
import clientSource from '../../src/torrent/client.ts?raw'
import protocolSource from '../../src/torrent/engine-protocol.ts?raw'
import workerSource from '../../src/torrent/worker.ts?raw'
