...
import { CACHE_SHARE, MAX_CACHE_BYTES, MIN_FREE_BYTES, cacheBudget, evictionFloor, planEviction } from './storage-budget'
import type { Budget, EvictionCandidate } from './storage-budget'
