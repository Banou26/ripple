...
// The @videojs VideoSkin layout with deliberate changes owned by ripple: volume moved next to play/pause, the plus/minus 10s buttons removed on purpose
// (hotkeys and gestures still seek), and the native captions toggle replaced by the jassub-driven menu slot.
